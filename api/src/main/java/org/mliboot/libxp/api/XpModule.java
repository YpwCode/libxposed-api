...
public abstract class XpModule extends IXpInterWrapper implements IXpModuleInter {
    /**
     ...
     */
    public XpModule(@NonNull IXpInter base, @NonNull IXpModuleInter.ModuleLoadedParam param) {
        super(base);
    }
}
